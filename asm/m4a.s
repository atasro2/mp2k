...
_08001EB0:
	...
	bx r0
	.align 2, 0
_08001EB8: .4byte 0x68736D53

	THUMB_FUNC_START MPlayVolumeControl
MPlayVolumeControl: @ 0x08001EBC
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_08001F14:
	...
	bx r0
	.align 2, 0
_08001F20: .4byte 0x68736D53

	THUMB_FUNC_START MPlayPitchControl
MPlayPitchControl: @ 0x08001F24
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08001F86:
	...
	bx r0
	.align 2, 0
_08001F94: .4byte 0x68736D53

	THUMB_FUNC_START MPlayPanpotControl
MPlayPanpotControl: @ 0x08001F98
	push {r4, r5, r6, r7, lr}
	mov r7, sb
	mov r6, r8
	push {r6, r7}
...
_08001FF0:
	...
	bx r0
	.align 2, 0
_08001FFC: .4byte 0x68736D53

	THUMB_FUNC_START MP_clear_modM
MP_clear_modM: @ 0x08002000
	adds r1, r0, #0
	movs r2, #0
	movs r0, #0
	strb r0, [r1, #0x1a]
...
_08002080:
	...
	bx r0
	.align 2, 0
_08002090: .4byte 0x68736D53

	THUMB_FUNC_START MPlayLFOSpeedSet
MPlayLFOSpeedSet: @ 0x08002094
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_080020F4:
	...
	bx r0
	.align 2, 0
_08002104: .4byte 0x68736D53

	THUMB_FUNC_START ply_memacc
ply_memacc: @ 0x08002108
	push {r4, r5, r6, lr}
	adds r4, r0, #0
	adds r6, r1, #0
	ldr r1, [r6, #0x40]
...
_0800213C: @ jump table
	.4byte _08002184 @ case 0
	.4byte _08002188 @ case 1
	.4byte _08002190 @ case 2
	.4byte _08002198 @ case 3
	.4byte _080021A2 @ case 4
	.4byte _080021B0 @ case 5
	.4byte _080021BE @ case 6
	.4byte _080021C6 @ case 7
	.4byte _080021CE @ case 8
	.4byte _080021D6 @ case 9
	.4byte _080021DE @ case 10
	.4byte _080021E6 @ case 11
	.4byte _080021EE @ case 12
	.4byte _080021FC @ case 13
	.4byte _0800220A @ case 14
	.4byte _08002218 @ case 15
	.4byte _08002226 @ case 16
	.4byte _08002234 @ case 17
_08002184:
	strb r2, [r3]
	b _0800225A
_08002188:
...
ply_xwave: @ 0x08002294
	...
	bx r0
	.align 2, 0
_080022CC: .4byte 0xFFFFFF00
_080022D0: .4byte 0xFFFF00FF
_080022D4: .4byte 0xFF00FFFF
_080022D8: .4byte 0x00FFFFFF

	THUMB_FUNC_START ply_xtype
ply_xtype: @ 0x080022DC
	ldr r0, [r1, #0x40]
	ldrb r2, [r0]
	adds r0, r1, #0
	adds r0, #0x24
